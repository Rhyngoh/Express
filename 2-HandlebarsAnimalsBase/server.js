...
app.get("/api/:ani", function(req, res) {
  var myAnimal = req.params.ani;
 for (var i = 0; i < animals.length; i++) {
      if (myAnimal === animals[i].animalType) {
...
app.get("/all-pets", function(req, res) {
  ...
  for(var i =0; i < animals.length; i ++){
    ...
    if(currentAnimal.pet){
      themAnimals.allPetsArray.push(currentAnimal);    
    }
  }
  res.render("index", themAnimals);
